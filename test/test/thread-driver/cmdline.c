...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --tty=STRING  Serial device for NCP",
    0
};
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->tty_given)
    {
      fprintf (stderr, "%s: '--tty' ('-t') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 't':	/* Serial device for NCP.  */
        
        
          if (update_arg( (void *)&(args_info->tty_arg), 
               &(args_info->tty_orig), &(args_info->tty_given),
              &(local_args_info.tty_given), optarg, 0, 0, ARG_STRING,
